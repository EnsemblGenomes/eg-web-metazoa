...
package EnsEMBL::Web::Component::Gene::ProtostomesTree;
...
sub _init {
  ...
  # We need to convince our code to do the same as for the default tree, only for the protostomes one;
  # and this, after several less successful attempts, seemed like the easiest way to do so.
  my $cgi_input = $self->hub->input;
  $cgi_input->param('clusterset_id', 'protostomes'); # Forgive me, for I have sinned.
